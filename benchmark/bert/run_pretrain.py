...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=8,
        type=int,
        help="Number of devices within a parallel group.", )
    parser.add_argument(
        "--learning_rate",
        default=5e-5,
        type=float,
    ...
    while True:
        ...
        for f_id in range(f_start_id + 1, len(files)):
            ...
            for step, batch in enumerate(train_data_loader):
                global_step += 1
                if step == 10 and worker_index == 0: profiler.start_profiler("All")
                if step == 20 and worker_index == 0: profiler.stop_profiler("total", "/tmp/profile")
